...
public class Author extends TableImpl<AuthorRecord> {
    ...
    private static final long serialVersionUID = -453048313;

    /**
     * The reference instance of <code>jooq_flyway.author</code>
     */
    ...
    /**
     * The column <code>jooq_flyway.author.last_name</code>.
     */
    ...
    /**
     * The column <code>jooq_flyway.author.age</code>.
     */
    public final TableField<AuthorRecord, Integer> AGE = createField("age", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.inline("20", org.jooq.impl.SQLDataType.INTEGER)), this, "");

    /**
     * Create a <code>jooq_flyway.author</code> table reference
     */
    public Author() {
        this("author", null);
    }
    ...
    /**
     * Create an aliased <code>jooq_flyway.author</code> table reference
     */
